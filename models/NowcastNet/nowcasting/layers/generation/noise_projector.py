...
from models.NowcastNet.nowcasting.layers.utils import spectral_norm

class Noise_Projector(nn.Module):
    def __init__(self, ngf: int = 32):
        """
        Noise Projector module.
        ...
        self.ngf = ngf
        self.conv_first = spectral_norm(nn.Conv2d(self.ngf, self.ngf * 2, kernel_size=3, padding=1))
        self.L1 = ProjBlock(self.ngf * 2, self.ngf * 4)
        self.L2 = ProjBlock(self.ngf * 4, self.ngf * 8)
        self.L3 = ProjBlock(self.ngf * 8, self.ngf * 16)
        self.L4 = ProjBlock(self.ngf * 16, self.ngf * 32)
