...
def weight_fn(y, precip_weight_cap=10.0):
    """
    ...
    """
    return y * (precip_weight_cap - 1.0) + 1.0
...
class DGMR(
    ...
    def __init__(
        ...
        Args:
            ...
            num_context_steps: Number of context frames to use.
        """
        super().__init__()
    ...
    def training_step(self, batch, batch_idx):
        ...
        images, future_images = batch["sequence"].unsqueeze(2), batch["target"].unsqueeze(2)
        images = images.float()
    ...
    def validation_step(self, batch, batch_idx):
        ...
        log_loss(
            pred=generated_images.squeeze(2),
            truth=future_images.squeeze(2),
            stage="val",
